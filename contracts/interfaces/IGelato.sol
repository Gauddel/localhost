...
import { TaskReceipt } from "@gelatonetwork/core/contracts/gelato_core/interfaces/IGelatoCore.sol";
import { IGelatoV1 } from "./standard/IGelatoV1.sol";
...
interface IGelato {
  ...
  function unstakeExecutor(IGelatoV1 _gelatoCore, address payable _to) external;
  ...
  function getGasLimit(TaskReceipt calldata _taskReceipt, uint256 _gelatoMaxGas)
    external
    pure
    returns (uint256);
}
